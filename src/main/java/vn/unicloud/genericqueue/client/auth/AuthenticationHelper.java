package vn.unicloud.genericqueue.client.auth;
...
public class AuthenticationHelper {
    ...
    public static SalesforceSession login(String loginUrl, String username, String password, String secretToken) throws AuthenticationException {
		return new SalesforceSession("", "orgId", "127.0.0.1");
