package vn.unicloud.genericqueue.client.events;
...
public class EventParser {
	 ...
	 */
	private static ChangeEventHeader.ChangeType parseChangeType(Record record, String fieldName) {
		String stringValue = record.get(fieldName).toString();
		return ChangeEventHeader.ChangeType.valueOf(stringValue);
	}
